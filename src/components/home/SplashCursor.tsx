...
const SplashCursor = React.memo(function SplashCursor({
  SIM_RESOLUTION = 128,
  DYE_RESOLUTION = 1440,
  ...
  return (
    <div className="fixed inset-0 z-50 pointer-events-none w-full h-full">
      <canvas ref={canvasRef} id="fluid" className="w-screen h-screen block bg-transparent" style={{ willChange: 'transform' }}></canvas>
    </div>
  );
});
